 ...
 */
public class LinksProcessorMessageCreatorCharacterSetB implements CustJavaNodeInterface {
    private static final long serialVersionUID = -1920658175701471965L;
    private static final Log log = LogFactory.getLog(LinksProcessorMessageCreatorCharacterSetB.class);
    ...
    public Object executeNodeLogic(TestExec testExec, Map params) throws TestRunException {
        ...
        try {
            ...
            message = message +"Sending the following links processor to destination :: " + "\n" + links_headerString + "\n\n";
            ...
            byte [] links_headerBytes  = DatatypeConverter.parseHexBinary("484452000000007F20000000525447000000007344514D000000000544554D4D5944514E0000000011415452000000000931415F41415F5241414F514D00000000086C697361627731584F514E000000000931415F41415F52414153544B0000000004000F675444544B00000000040000001850524F000000000400000004");
