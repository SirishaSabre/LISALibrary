 ...
 */
public class SabreRawSocketClientStep implements CustJavaNodeInterface {
    ...
    public Object executeNodeLogic(TestExec testExec, Map params) throws TestRunException
    {
        ...
        try
        {
            ...
            System.out.println("edifact_payloadString::" + edifact_payloadString);
            ...
            System.out.println("SabreRawSocketClientStep edi_wireMsgh::" + edi_wireMsg);
            System.out.println("SabreRawSocketClientStep edi_wireMsgh.length::" + edi_wireMsg.length());
...
//                     .append(edifact_payloadString);
            ...
            if (StringUtils.isNotBlank(responseString))
            {
                ...
                if(StringUtils.indexOf(responseString, "UNB") > -1)
                {
                    String temp = responseString.substring(StringUtils.indexOf(responseString, "UNB"));
